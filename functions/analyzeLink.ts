    ...
    try {
        ...
        const llmResponse = await base44.integrations.Core.InvokeLLM({
            ...
            **Instructions:**
            ...
            2. **Summary**: Write a paragraph that fits EXACTLY 5 lines (approx 50-60 words). It MUST be a complete text ending with a period. Do NOT end with "...". Do NOT start with "The video is about...". focus on the most important information.
